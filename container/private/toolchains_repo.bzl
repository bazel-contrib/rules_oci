...
def _resolved_toolchain_impl(ctx):
    toolchain_info = ctx.toolchains["@rules_container//container:toolchain_type"]
    return [
        toolchain_info,
        toolchain_info.default,
        toolchain_info.containerinfo,
...
# By default all these toolchains are registered by the container_register_toolchains macro
...
toolchain(
    ...
    toolchain_type = "@rules_container//container:toolchain_type",
)
""".format(
            platform = platform,
