...
def _resolved_toolchain_impl(ctx):
    toolchain_info = ctx.toolchains["@aspect_rules_oci//oci:toolchain_type"]
    return [
        toolchain_info,
        toolchain_info.default,
        toolchain_info.oci_info,
...
# By default all these toolchains are registered by the oci_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:oci_toolchain",
    toolchain_type = "@aspect_rules_oci//oci:toolchain_type",
)
""".format(
            platform = platform,
