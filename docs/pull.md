...
| <a id="oci_pull-image"></a>image |  the remote image without a tag, such as <code>gcr.io/bazel-public/bazel</code> One of image or {registry,repository} should be set.   |  <code>None</code> |
| <a id="oci_pull-repository"></a>repository |  the image path beneath the registry, such as <code>distroless/static</code>   |  <code>None</code> |
| <a id="oci_pull-registry"></a>registry |  the remote registry domain, such as <code>gcr.io</code>   |  <code>None</code> |
