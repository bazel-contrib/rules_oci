...
readonly ATTACHER_NO_REPO="$(rlocation $4)"
...
# download the sbom
"${COSIGN}" verify-attestation "$REF" --key=cosign.pub --type spdx --output json | "${JQ}" -r ".payload | @base64d | fromjson | .predicate" > "$TEST_TMPDIR/download.sbom"
